...
```
##### Table 1. The Adjusted Rand Index for modules recovery by TGCnA with simulation and transformed simulation
...
##### Figure 1. The true correlation matrix (True), the recovered correlation matrix by TGCnA with simulation (Sim) and transformed simulation (Tran)
